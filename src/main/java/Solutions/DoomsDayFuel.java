...
/*
This is not my code! I have putted here,
because I want to have the solution and to try to understand it!

I did not understand the problem at first and needed to read it multiple
times. Also, my knowledge of algorithms and my problem-solving skills is
not on that high level.

I hope in the near future to continue with the FooBar challenges and to be
able to do them on my own using Java, of course!
